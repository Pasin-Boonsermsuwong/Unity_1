...
public class ItemData{
	...
	public static string[][] itemInfo = {
		...
		new string[]{"4","WEAPON1","itemBeamBasic","Standard beam","Beam"}
	};
		//ID , firerate, speedMin, speedMax, bullet prefab name, shotDeviation, energyRequirement, shotAmount
	public static string[][] info = {
		new string[]{"0","0.3","800","800","shotBolt","5","30","1","false"},
		new string[]{"1","1","600","1000","shotBolt","13","120","6","false"},
		new string[]{"2","1","2000","2500","shotLarge","0","150","1","false"},
		new string[]{"3","1","400","400","shotRocket","1","200","1","false"},
		new string[]{"4","0","0","0","beamBasic","0","5","0","true"}
	};
...
public class ZoneData{
	...
	//	new string[]{"0","Enemy1","AsteroidBig",null,null,null,"0.01","0.01",null,null,null,"tile_nebula_green_dff","8","4","TEST SECTOR"},
		...
		new string[]{"2","Enemy1","Asteroid",null,null,null,"0.007","0.004",null,null,null,"tile_nebula_green_dff","8","4","Open Space"},
		new string[]{"3","Enemy1","EnemyRed",null,null,null,"0.004","0.001",null,null,null,"backgroundRed","6","6","Dangerous Space"},
		new string[]{"4","Asteroid","AsteroidBig",null,null,null,"0.03","0.001",null,null,null,"backgroundAsteroid2","6","6","Dense Asteroid Field"},
		new string[]{"5","EnemyRed",null,null,null,null,"0.01",null,null,null,null,"backgroundRed","6","6","Death Zone"}
