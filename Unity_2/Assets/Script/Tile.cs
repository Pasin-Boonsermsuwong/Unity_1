...
public class Tile : MonoBehaviour {
	...
	void UpdateTiling()
	{
		...
		gameObject.GetComponent<SpriteRenderer>().material.mainTextureScale = new Vector2(planeSizeX*gameObject.transform.lossyScale.x/textureToMeshX, planeSizeZ*gameObject.transform.lossyScale.z/textureToMeshZ);
	}
}